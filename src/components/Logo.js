...
function Logo({ includeBorder }) {
    const theme = useContext(ThemeContext);

    return (
        <>
            <div className='sm:hidden md:flex xl:flex lg:flex vs:hidden w-[100%] h-[100%]'>
                {theme.color === 'light' ?
                    <div className={`flex justify-center items-center w-[100%] h-[100%]  ${includeBorder ? '' : 'border-r-[1px]'}  ${theme.color === 'dark' ? "border-dark-lines" : 'border-light-darkBG'}`}>
