...
function EditBoard({ data, setShowEditBoard, idx }) {
    ...
    return (
        <div className={`overflow-scroll rounded-[6px] vs:h-[550px] vs:w-[270px] sm:w-[343px] sm:h-[473px] md:w-[480px] md:h-[600px] flex items-center justify-center ${theme.color === 'dark' ? "bg-dark-grey" : "bg-light-main"}`}>
