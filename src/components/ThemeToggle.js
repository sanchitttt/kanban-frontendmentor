...
function ThemeToggle() {
    ...
    return (
        <div className={`vs:w-[235px] vs:h-[48px] lg:w-[251px] lg:h-[48px] flex items-center justify-center ${theme.color === 'dark' ? 'bg-dark-darkBG' : 'bg-light-darkBG'}`}>
            <div className='lg:mr-[25px] vs:mr-[23px]' >
